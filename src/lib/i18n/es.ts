...
export const es = {
  ...
  status: {
    "not-owned": "No conseguido",
    available: "Disponible",
    "partially-installed": "Instalado parcialmente",
    covered: "Cubierto",
  ...
  home: {
    ...
    metrics: {
      ...
      pending: "Copias pendientes",
      covered: "Familias cubiertas",
  ...
  incarnon: {
    ...
    onlyIncompleteEvolutions: "Evoluciones incompletas",
    view: "Vista",
    viewCards: "Tarjetas",
    viewTable: "Tabla",
    ...
    variant: "Variante",
    summaryInstalled: "instalado",
    summaryAvailable: "disponible",
    summaryPending: "pendiente",
    extraCopies: "copia extra",
    extraCopiesPlural: "copias extra",
    viewEvolutions: "Ver evoluciones",
